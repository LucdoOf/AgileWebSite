<div id="home-page">
    <div id="home-wrapper" class="row align justify">
        <div id="centered-wrapper" class="wrapper column align">
            <div id="computer-wrapper" class="wrapper row">
                ...
                <img id="computer-img" alt="Computer" src="res/images/svg/computer.svg"/>
            </div>
            <div id="discover" class="wrapper column cw justify align">
                <a class="cw">Découvrez en plus !</a>
                <img id="arrow" alt="Flèche" src="res/images/svg/arrow.svg"/>
            </div>
        </div>
    </div>
    ...
    <div id="roadmap-wrapper">
        ...
        <div id="roadmap-grid">
            <div class="roadstep">
                ...
                <h4>1. L'idée</h4
                <p>Lorem ipsum dolor sit amet et mortum</p>
            </div>
            <div class="roadstep">
                <img src="res/images/svg/design.svg" alt="Design"/>
                <h4>2. Le design</h4
                <p>Lorem ipsum dolor sit amet et mortum</p>
            </div>
            <div class="roadstep">
                <img src="res/images/svg/conception.svg" alt="Conception"/>
                <h4>3. La conception</h4
                <p>Lorem ipsum dolor sit amet et mortum</p>
            </div>
            <div class="roadstep">
                <img src="res/images/svg/validation.svg" alt="Validation"/>
                <h4>4. La validation</h4
                <p>Lorem ipsum dolor sit amet et mortum</p>
            </div>
            <div class="roadstep">
                <img src="res/images/svg/retouches.svg" alt="Retouches"/>
                <h4>5. Les retouches</h4
                <p>Lorem ipsum dolor sit amet et mortum</p>
            </div>
            <div class="roadstep">
                <img src="res/images/svg/production.svg" alt="Mise en production"/>
                <h4>6. La mise en production</h4
                <p>Lorem ipsum dolor sit amet et mortum</p>
            </div>
        </div>
    </div>
    ...
    <div id="references-wrapper">
        ...
        <p id="references-paragraph">Agile-web.net est une jeune entreprise grandissante. Nous listons ici quelques-une de nos références de nos clients les plus satisfaits. </p>
        <div id="references-grid" class="column">
            <a class="reference-link" href="https://www.geopole.net" target="_blank">
                <div class="reference-wrapper">
                    <img src="res/images/thumbnails/geopole.png"/>
                    <div class="reference-text">
                        <h3 class="cw">GéoPôle</h3>
                        <p class="cw">GéoPôle est un site proposant articles et débats sur des sujets de société. Nous leur avons proposé un service complet incluant le développement front ainsi que d'un backend performant.</p>
                    </div>
                </div>
            </a>
        </div>
